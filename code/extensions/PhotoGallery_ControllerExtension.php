...
class PhotoGallery_ControllerExtension extends Extension {
    ...
    public function __construct() {
        ...
        Requirements::CSS("video-embed/assests/javascript/shadowbox/shadowbox.css");
        Requirements::javascript("http://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js");
        Requirements::javascript("video-embed/assests/javascript/shadowbox/shadowbox.js");
        Requirements::javascriptTemplate('video-embed/assests/javascript/shadowbox_init.js', array());
    }
}
